...
# finsing number of items in the list, sorting the list, adding/removing items.
...
dogs = ["Sadie", "Molly", "Ella", "Milo", "Buddy", "Rocky", "AnnaBelle",
        "Gonzo", "Sweetie-Pie", "Diego", "Abigail", "Angus",]
dogs2 = []
...
def main():
    ...
    print("Pop a dog off from position 3 (which is 4th dog) in the list:")
    print(dogs)

    dogs.remove('AnnaBelle')
    print("\nRemove a dog by name rather than position 3 of the list:")
    print(dogs)

    dogs2 = dogs
    print("\nA list can be copied into another list by setting one equal to the another:")
    print(dogs)
    print(dogs2)

    print("\nUse a FOR loop to give each dog in the same last name:")
    for i in range(len(dogs)):
        dogs[i] = dogs[i] + " Nawrozi"
        print(dogs[i])
main()
